...
CHARA_NAME = {
    ...
    1142: ["莫妮卡(魔法少女)", "モニカ(マジカル)", "魔法少女莫妮卡", "魔法毛二力", "魔法少女毛二力", "魔二力"],
    ...
    1155: ["可可萝(仪装束)", "コッコロ(儀装束)", "Kokkoro(suit)", "仪妈", "礼妈", "猫耳妈", "仪可", "礼服可萝", "礼服可可萝", "礼可", "猫耳可萝", "猫耳可可萝"],
    1156: ["优衣(仪装束)", "ユイ(儀装束)", "Yui(suit)", "礼服优衣", "礼服yui", "礼服种田", "礼田", "礼ue", "礼优衣", "礼yui", "仪ue", "仪优衣", "仪yui"],
    1157: ["霞(夏日)", "カスミ(サマー)", "Kasumi(Summer)", "水香澄", "水侦探", "泳装侦探", "水驴", "水驴子", "💧🔍","氵驴", "沪"],
    1158: ["莉玛(灰姑娘)", "リマ(シンデレラ)", "Rima(Cinderella)", "Lima(Cinderella)", "礼马", "礼服羊驼", "灰羊", "礼🐐","灰羊驼"],
    1159: ["真琴(灰姑娘)", "マコト(シンデレラ)", "Makoto(Cinderella)", "灰狼", "灰🐺", "灰月月", "灰朋", "灰狼姐","大灰狼","灰月","灰太狼"],
    1160: ["真步(灰姑娘)", "マホ(シンデレラ)", "Maho(Cinderella)", "灰狐狸", "灰真扎", "灰咕噜灵波", "灰真布", "灰🦊"],

    1162: ["克萝依(圣学祭)", "クロエ(聖学祭)", "Kuroe(gakusai)", "圣华哥"],
    1163: ["琪爱儿(圣学祭)", "チエル(聖学祭)", "Chieru(gakusai)", "圣切噜"],

    1165: ["祈梨(时间旅行)", "イノリ(タイムトラベル)", "Inori(timetravel)", "火车梨老八", "火车李老八", "火车龙锤", "火车🐲🔨"],
    ...
    1806: ["凯留(公主)", "キャル(プリンセス)", "Karyl(Princess)", "Kyaru(Princess)", "公主凯露", "公猫", "公主凯留", "Kiruya(Princess)", "公主黑猫", "公主臭鼬", "公黑"],
