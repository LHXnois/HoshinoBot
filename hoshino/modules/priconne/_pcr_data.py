...
CHARA_NAME = {
    ...
    1118: ["贪吃佩可(新年)", "ペコリーヌ(ニューイヤー)", "Pecorine(NewYear)", "Pekoriinu(NewYear)", "佩可莉姆(新年)", "春吃", "春饭", "春吃货", "春佩可", "春🍙"],
    ...
    1139: ["纺希(万圣节)", "ツムギ(ハロウィン)", "Tsumugi(Halloween)", "万圣裁缝", "万圣节裁缝", "万圣蜘蛛侠", "万圣节蜘蛛侠", "🎃🕷️", "🎃🕸️", "万裁", "瓜裁", "鬼裁", "鬼才"],
    ...
    1147: ["矛依未(新年)", "ムイミ(ニューイヤー)", "Muimi(NewYear)", "新年511", "春511", "冲锋511", "春姆咪", "冲锋母咪"],

    1150: ["似似花(新年)", "ネネカ(ニューイヤー)", "Neneka(NewYear)", "春nnk", "春448", "春捏捏卡"],
    ...
    1702: ["环奈(新年)", "カンナ(ニューイヤー)", "Kanna(NewYear)", "春环", "二环"],
    ...
    # =================================== #
    1801: ["日和(公主)", "ヒヨリ(プリンセス)", "Hiyori(Princess)", "公主日和", "公主猫拳", "火猫", "火🐱"],
