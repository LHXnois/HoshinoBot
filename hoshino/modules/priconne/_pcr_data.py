...
CHARA_NAME = {
    ...
    1064: ["雪菲", "シェフィ", "Shephy", "Shefi", "紫布菜", "雪非"],
    ...
    1118: ["贪吃佩可(新年)", "ペコリーヌ(ニューイヤー)", "Pecorine(NewYear)", "Pekoriinu(NewYear)", "春吃", "春饭", "新吃", "新年吃货", "年货", "春佩可", "春🍙"],
    ...
    1139: ["纺希(万圣节)", "ツムギ(ハロウィン)", "Tsumugi(Halloween)", "万圣裁缝", "万圣蜘蛛侠", "万圣节蜘蛛侠", "🎃🕷️", "🎃🕸️", "万裁", "瓜裁", "鬼裁", "鬼才", "万圣节裁缝"],
    1140: ["怜(万圣节)", "レイ(ハロウィン)", "Rei(Halloween)", "万圣剑圣", "万剑", "瓜剑", "瓜怜", "万圣怜", "鬼剑"],
    1141: ["茉莉(万圣节)", "マツリ(ハロウィン)", "Matsuri(Halloween)", "万圣跳跳虎", "万圣老虎", "瓜虎", "🎃🐅"],
    1142: ["莫妮卡(魔法少女)", "モニカ(マジカル)", "Monika(MagiGirl)", "魔法少女莫妮卡", "魔二力", "魔法毛二力"],
    ...
    1147: ["矛依未(新年)", "ムイミ(ニューイヤー)", "Muimi(NewYear)", "新年511", "春511", "春矛", "冲锋511", "春姆咪", "冲锋母咪"],

    1150: ["似似花(新年)", "ネネカ(ニューイヤー)", "Neneka(NewYear)", "春nnk", "春448", "春捏捏卡", "新年似似花", "春似似花", "春花", "新年nnk"],


    1155: ["可可萝(仪装束)", "コッコロ(儀装束)", "Kokkoro(Costume)", "礼妈", "仪妈", "仪装妈", "姨妈", "猫耳妈", "猫耳可萝", "猫耳可可萝"],
    1156: ["优衣(仪装束)", "ユイ(儀装束)", "Yui(Costume)", "礼ue", "礼装ue", "礼装优衣", "仪装ue", "礼衣", "礼田"],
    1157: ["霞(夏日)", "カスミ(サマー)", "Kasumi(Summer)", "水驴", "泳装驴", "沪", "水侦探", "泳装侦探"],
    1158: ["莉玛(灰姑娘)", "リマ(シンデレラ)", "Rima(Cinderella)", "人形羊驼", "人驼", "灰驼", "灰姑娘羊驼"],
    1159: ["真琴(灰姑娘)", "マコト(シンデレラ)", "Makoto(Cinderella)", "灰姑娘狼", "灰狼", "灰🐺", "灰月月", "灰朋", "灰狼姐","大灰狼","灰月","灰太狼"],
    1160: ["真步(灰姑娘)", "マホ(シンデレラ)", "Maho(Cinderella)", "灰姑娘狐狸", "灰狐狸", "灰狐", "灰🦊"],

    1162: ["克萝依(圣学祭)", "クロエ(聖学祭)", "Kuroe(Seigakusai)", "运动华", "圣学祭华", "圣学祭克萝依", "圣华哥"],
    1163: ["琪爱儿(圣学祭)", "チエル(聖学祭)", "Chieru(Seigakusai)", "运动切噜", "圣学祭切噜", "圣学祭琪爱儿", "圣切噜"],

    1165: ["祈梨(时间旅行)", "イノリ(タイムトラベル)", "Inori(TimeTravel)", "时间旅行龙锤", "穿越龙锤", "穿越梨老八", "军装龙锤", "元首龙锤", "元首", "元老八"],
    1166: ["嘉夜(时间旅行)", "カヤ(タイムトラベル)", "Kaya(TimeTravel)", "时间旅行憨憨龙", "穿越龙拳", "穿越🐲👊🏻", "穿越🐉👊🏻", "穿越接龙笨比", "穿越鬼道嘉夜", "水手龙", "水手龙拳"],
    1167: ["碧(作业服)", "アオイ(作業服)", "Aoi(Sagyoufuku)", "碧(工作服)", "工菜", "韭菜"],
    1168: ["珠希(作业服)", "タマキ(作業服)", "Tamaki(Sagyoufuku)", "珠希(工作服)", "工猫贼", "工猫剑", "工贼"],
    1169: ["美冬(作业服)", "ミフユ((作業服)", "Mifuyu(Sagyoufuku)", "工子龙", "工美冬"],
    1170: ["惠理子(夏日)", "エリコ(サマー)", "Eriko(Summer)", "水病娇", "水病", "情病"],
    1171: ["静流(夏日)", "シズル(サマー)", "Shizuru(Summer))", "水静流", "水姐", "水姐姐"],
    ...
    # =================================== #
    1801: ["日和(公主)", "ヒヨリ(プリンセス)", "Hiyori(Princess)", "公主日和", "公主猫拳", "火猫", "火🐱", "炎拳猫"],
    1802: ["优衣(公主)", "ユイ(プリンセス)", "Yui(Princess)", "公主优衣", "公主yui", "公主种田", "公主田", "公主ue", "掉毛优衣", "掉毛yui", "掉毛ue", "掉毛", "飞翼优衣", "飞翼ue", "飞翼", "飞翼高达", "飞田", "羽田", "羽衣", "毛衣"],
    1803: ["怜(公主)", "レイ(プリンセス)", "Rei(Princess)", "公主剑", "公主怜", "公主伶", "公主剑圣", "公怜", "公剑"],
    ...
    1806: ["凯留(公主)", "キャル(プリンセス)", "Karyl(Princess)", "Kyaru(Princess)", "凯露(公主)", "公主凯露", "公主猫猫头", "白猫", "公猫", "公主凯留", "Kiruya(Princess)", "公主黑猫", "公主臭鼬", "公黑"],
...
CHARA_PROFILE = {
    ...
    1036: {"名字": "镜华", "公会": "小小甜心", "生日": "2月2日", "年龄": "8", "身高": "118cm", "体重": "21kg", "血型": "A", "种族": "精灵族", "喜好": "读书", "声优": "小仓唯", "称号": "资优生", "对骑士君称呼": "变态可疑人士"},
    ...
    1068: {"名字": "拉比林斯达", "公会": "拉比林斯", "生日": "7月25日", "年龄": "25", "身高": "160cm", "体重": "？？？kg", "血型": "AB", "种族": "人族", "喜好": "观察人类", "声优": "沢城みゆき", "特技": "操纵迷宫", "特技(?)": "普通的可丽饼", "称号": "迷宫女王"},
    ...
    1092: {"名字": "安", "公会": "？？？", "生日": "12月1日", "年龄": "17", "身高": "156cm", "体重": "55kg", "血型": "AB", "种族": "人族", "喜好": "读书，古蕾娅", "声优": "日笠阳子"},
    1093: {"名字": "露", "公会": "？？？", "生日": "2月4日", "年龄": "15", "身高": "144cm", "体重": "45kg", "血型": "O", "种族": "人族", "喜好": "吃饭、睡觉", "声优": "古山贵实子","称号":"(从补考)逃了100万次的学生"},
    1094: {"名字": "古蕾娅", "公会": "？？？", "生日": "11月3日", "年龄": "17", "身高": "167cm", "体重": "67kg", "血型": "B", "种族": "半人半龙", "喜好": "钢琴", "声优": "福原绫香"},
    1097: {"名字": "雷姆", "公会": "？？？", "生日": "2月2日", "年龄": "17", "身高": "154cm", "体重": "？？？kg", "血型": "？？？", "种族": "鬼族", "喜好": "戏剧欣赏、诗和散文", "声优": "水濑祈","职业":"女仆","武器":"流星锤","特技":"鬼化"},
    1098: {"名字": "拉姆", "公会": "？？？", "生日": "2月2日", "年龄": "17", "身高": "154cm", "体重": "？？？kg", "血型": "？？？", "种族": "鬼族", "喜好": "读书", "声优": "村川梨衣","职业":"女仆"},
